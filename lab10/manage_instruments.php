...
// Handle Add/Delete (POST-redirect-GET)
if ($_SERVER['REQUEST_METHOD'] === 'POST') {

    // Add a new instrument_type
...
<?php if (!empty($rows)): ?>
  ...
  <table>
    ...
    <?php foreach ($rows as $r): ?>
      <tr>
        <td><?= (int)$r['instrument_id'] ?></td>
        <td><?= htmlspecialchars($r['instrument_type']) ?></td>
      </tr>
    <?php endforeach; ?>
    </tbody>
  </table>
